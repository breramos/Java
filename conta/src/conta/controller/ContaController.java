...
public class ContaController implements ContaRepository{
	...
	private ArrayList<Conta> listaContas = new ArrayList<Conta>(); //Criou array list que vai guardar os valores da variável listaContas.
	int numero = 0;
	...
	public void listarTodas() {
		for(var conta: listaContas) { //laço for each: criar variável, 
			conta.visualizar();
		}
